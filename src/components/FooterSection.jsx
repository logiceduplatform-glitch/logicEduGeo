        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mb-10">
          ...
          <div>
            ...
            <p className="text-xs font-semibold text-amber-400 tracking-wider uppercase mb-2">
              {isEl ? "Όπου η περιέργεια ανθίζει" : "Where curiosity blooms"}
            </p>
            <p className="text-sm leading-relaxed">
              {isEl
                ? "Ένας χαρούμενος κόσμος μάθησης! Παιχνίδια για παιδιά 2-12 ετών και περίεργους ενήλικες."
                : "A playful learning world! Games for kids 2-12 and curious adults."}
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              {FeatureFlagService.isEnabled("forSchoolsPage") && (
                <li><a href="/for-schools" className="hover:text-white transition-colors">{isEl ? "🏫 Για Σχολεία (B2B)" : "🏫 For Schools (B2B)"}</a></li>
              )}
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="https://www.instagram.com/kibloo" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-8 h-8 rounded-lg bg-slate-800 hover:bg-pink-600 flex items-center justify-center text-slate-400 hover:text-white transition-all">
              ...
              <a href="https://www.youtube.com/@kibloo" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="w-8 h-8 rounded-lg bg-slate-800 hover:bg-red-600 flex items-center justify-center text-slate-400 hover:text-white transition-all">
