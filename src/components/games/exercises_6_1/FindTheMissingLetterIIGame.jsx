// src/components/games/exercises_6_1/FindTheMissingLetterIIGame.jsx
import React, { useState, useRef, useEffect } from "react";
import { useQuizProgress } from "../../../hooks/useQuizProgress";
export default function FindTheMissingLetterIIGame({ lang = "el", onComplete }) {
  ...
  const generateProblems = () => {
    const wordsData = {
      el: [
        { word: "κερί", missing: "ί", position: 2, display: "κερ_", emoji: "🕯️" },
          { word: "ζύμη", missing: "ύ", position: 1, display: "ζ_μη", emoji: "🥐" },
          { word: "σκύλος", missing: "ύ", position: 2, display: "σκ_λος", emoji: "🐶" },
          { word: "μηλιά", missing: "η", position: 1, display: "μ_λιά", emoji: "🌳" },
          { word: "πιρούνι", missing: "ι", position: 1, display: "π_ρούνι", emoji: "🍴" },
          { word: "χωρίο", missing: "ι", position: 3, display: "χωρ_ό", emoji: "🏘️" },
          { word: "συννεφιά", missing: "υ", position: 1, display: "σ_ννεφιά", emoji: "☁️" },
          { word: "νίκη", missing: "ί", position: 1, display: "ν_κη", emoji: "🏆" },
          { word: "θησαυρός", missing: "η", position: 1, display: "θ_σαυρός", emoji: "💰" },
          { word: "σφυρί", missing: "υ", position: 2, display: "σφ_ρί", emoji: "🔨" },
          { word: "κιθάρα", missing: "ι", position: 1, display: "κ_θάρα", emoji: "🎸" },
          { word: "πηγάδι", missing: "η", position: 1, display: "π_γάδι", emoji: "⛲" },
          { word: "ελπίδα", missing: "ί", position: 3, display: "ελπ_δα", emoji: "🌟" },
            { word: "βρύση", missing: "ύ", position: 2, display: "βρ_ση", emoji: "🚰" },
            { word: "πηγή", missing: "η", position: 2, display: "π_γή", emoji: "💧" },
            { word: "καρφί", missing: "ί", position: 4, display: "καρφ_", emoji: "📌" },
            { word: "φυλή", missing: "υ", position: 1, display: "φ_λή", emoji: "👥" },
            { word: "τυρί", missing: "υ", position: 1, display: "τ_ρί", emoji: "🧀" },
            { word: "μύτη", missing: "ύ", position: 1, display: "μ_τη", emoji: "👃" },
            { word: "πίτα", missing: "ί", position: 1, display: "π_τα", emoji: "🥧" },
            { word: "πηλός", missing: "η", position: 1, display: "π_λός", emoji: "🧱" },
            { word: "χυμός", missing: "υ", position: 1, display: "χ_μός", emoji: "🧃" },
            { word: "μηνύμα", missing: "η", position: 1, display: "μ_νύμα", emoji: "💬" },
            { word: "κτίριο", missing: "ί", position: 2, display: "κτ_ριο", emoji: "🏢" }
      ],
      en: [
        { word: "light", missing: "i", position: 1, display: "l_ght", emoji: "💡" },
          { word: "happy", missing: "h", position: 0, display: "_appy", emoji: "😊" },
          { word: "yellow", missing: "y", position: 0, display: "_ellow", emoji: "🟡" },
          { word: "night", missing: "i", position: 2, display: "n_ght", emoji: "🌙" },
          { word: "house", missing: "h", position: 0, display: "_ouse", emoji: "🏠" },
          { word: "sky", missing: "y", position: 0, display: "_ky", emoji: "🌌" },
          { word: "smile", missing: "i", position: 2, display: "sm_le", emoji: "😄" },
          { word: "white", missing: "h", position: 1, display: "w_ite", emoji: "🤍" },
          { word: "computer", missing: "u", position: 4, display: "comp_ter", emoji: "💻" }, // αν θες, το αλλάζω να είναι μόνο i/h/y
          { word: "mystery", missing: "y", position: 1, display: "m_stery", emoji: "🕵️‍♂️" },
          { word: "hill", missing: "h", position: 0, display: "_ill", emoji: "⛰️" },
          { word: "inside", missing: "i", position: 0, display: "_nside", emoji: "🏠" },
          { word: "alive", missing: "i", position: 2, display: "al_ve", emoji: "❤️" },
            { word: "happy", missing: "h", position: 0, display: "_appy", emoji: "😊" },
            { word: "mystic", missing: "y", position: 2, display: "m_stic", emoji: "✨" },
            { word: "bright", missing: "i", position: 2, display: "br_ght", emoji: "💡" },
            { word: "yellow", missing: "y", position: 0, display: "_ellow", emoji: "🟡" },
            { word: "horse", missing: "h", position: 0, display: "_orse", emoji: "🐴" },
            { word: "city", missing: "i", position: 1, display: "c_ty", emoji: "🏙️" },
            { word: "honey", missing: "h", position: 0, display: "_oney", emoji: "🍯" },
            { word: "rhythm", missing: "y", position: 4, display: "rhth_m", emoji: "🥁" },
            { word: "finish", missing: "i", position: 1, display: "f_nish", emoji: "🏁" },
            { word: "yellowish", missing: "y", position: 0, display: "_ellowish", emoji: "💛" },
            { word: "hilltop", missing: "h", position: 0, display: "_illtop", emoji: "⛰️" }
      ]
    };
    const words = wordsData[lang];
    // Only use vowels with accents for Greek, regular vowels for English
    const alphabet = lang === "el"
      ? "ιίηήυύ"  // Greek vowels with and without accents
      : "ihy";  // English vowels
