// src/components/games/exercises_6_1/WhatRemainsGame.jsx - Age 6 override
...
export default function WhatRemainsGame({ lang = "el", onComplete, difficulty = 3 }) {
  ...
  const subtractionsData = {
    el: [
      { id: 1, emoji: "🍎", name: "μήλα", initial: 8, remove: 3, remaining: 5, options: [4, 5, 6], color: "#EF4444" },
      { id: 2, emoji: "🍌", name: "μπανάνες", initial: 7, remove: 4, remaining: 3, options: [2, 3, 4], color: "#EAB308" },
      { id: 3, emoji: "⭐", name: "αστέρια", initial: 10, remove: 5, remaining: 5, options: [4, 5, 6], color: "#F59E0B" },
      { id: 4, emoji: "🎈", name: "μπαλόνια", initial: 6, remove: 2, remaining: 4, options: [3, 4, 5], color: "#10B981" },
      { id: 5, emoji: "🍪", name: "μπισκότα", initial: 9, remove: 4, remaining: 5, options: [4, 5, 6], color: "#EC4899" },
      { id: 6, emoji: "🐟", name: "ψάρια", initial: 8, remove: 5, remaining: 3, options: [2, 3, 4], color: "#A855F7" },
      { id: 7, emoji: "🍓", name: "φράουλες", initial: 10, remove: 7, remaining: 3, options: [2, 3, 4], color: "#3B82F6" },
      { id: 8, emoji: "🌸", name: "λουλούδια", initial: 7, remove: 3, remaining: 4, options: [3, 4, 5], color: "#F97316" },
      { id: 9, emoji: "🦋", name: "πεταλούδες", initial: 9, remove: 6, remaining: 3, options: [2, 3, 4], color: "#14B8A6" },
      { id: 10, emoji: "🍬", name: "γλυκά", initial: 10, remove: 4, remaining: 6, options: [5, 6, 7], color: "#8B5CF6" },
      { id: 11, emoji: "🐣", name: "κοτοπουλάκια", initial: 8, remove: 2, remaining: 6, options: [5, 6, 7], color: "#06B6D4" },
      { id: 12, emoji: "🎵", name: "νότες", initial: 6, remove: 3, remaining: 3, options: [2, 3, 4], color: "#EAB308" },
      { id: 13, emoji: "🌈", name: "κραγιόνια", initial: 9, remove: 5, remaining: 4, options: [3, 4, 5], color: "#EC4899" },
      { id: 14, emoji: "🧸", name: "αρκουδάκια", initial: 10, remove: 8, remaining: 2, options: [1, 2, 3], color: "#F59E0B" },
      { id: 15, emoji: "🎀", name: "φιόγκες", initial: 7, remove: 2, remaining: 5, options: [4, 5, 6], color: "#EF4444" }
    ],
    en: [
      { id: 1, emoji: "🍎", name: "apples", initial: 8, remove: 3, remaining: 5, options: [4, 5, 6], color: "#EF4444" },
      { id: 2, emoji: "🍌", name: "bananas", initial: 7, remove: 4, remaining: 3, options: [2, 3, 4], color: "#EAB308" },
      { id: 3, emoji: "⭐", name: "stars", initial: 10, remove: 5, remaining: 5, options: [4, 5, 6], color: "#F59E0B" },
      { id: 4, emoji: "🎈", name: "balloons", initial: 6, remove: 2, remaining: 4, options: [3, 4, 5], color: "#10B981" },
      { id: 5, emoji: "🍪", name: "cookies", initial: 9, remove: 4, remaining: 5, options: [4, 5, 6], color: "#EC4899" },
      { id: 6, emoji: "🐟", name: "fish", initial: 8, remove: 5, remaining: 3, options: [2, 3, 4], color: "#A855F7" },
      { id: 7, emoji: "🍓", name: "strawberries", initial: 10, remove: 7, remaining: 3, options: [2, 3, 4], color: "#3B82F6" },
      { id: 8, emoji: "🌸", name: "flowers", initial: 7, remove: 3, remaining: 4, options: [3, 4, 5], color: "#F97316" },
      { id: 9, emoji: "🦋", name: "butterflies", initial: 9, remove: 6, remaining: 3, options: [2, 3, 4], color: "#14B8A6" },
      { id: 10, emoji: "🍬", name: "candies", initial: 10, remove: 4, remaining: 6, options: [5, 6, 7], color: "#8B5CF6" },
      { id: 11, emoji: "🐣", name: "chicks", initial: 8, remove: 2, remaining: 6, options: [5, 6, 7], color: "#06B6D4" },
      { id: 12, emoji: "🎵", name: "notes", initial: 6, remove: 3, remaining: 3, options: [2, 3, 4], color: "#EAB308" },
      { id: 13, emoji: "🌈", name: "crayons", initial: 9, remove: 5, remaining: 4, options: [3, 4, 5], color: "#EC4899" },
      { id: 14, emoji: "🧸", name: "teddy bears", initial: 10, remove: 8, remaining: 2, options: [1, 2, 3], color: "#F59E0B" },
      { id: 15, emoji: "🎀", name: "ribbons", initial: 7, remove: 2, remaining: 5, options: [4, 5, 6], color: "#EF4444" }
    ]
  };
