// src/components/games/exercises_6_1/FindMissingNumberGame.jsx - Age 6 override
...
export default function FindMissingNumberGame({ lang = "el", onComplete, difficulty = 3 }) {
  ...
  const sequencesData = {
    el: [
      { id: 1, sequence: [2, 4, "?", 8, 10], missingNumber: 6, options: [4, 6, 8], color: "#EF4444" },
      { id: 2, sequence: [5, 10, "?", 20], missingNumber: 15, options: [12, 15, 18], color: "#10B981" },
      { id: 3, sequence: [1, 3, 5, "?", 9], missingNumber: 7, options: [6, 7, 8], color: "#3B82F6" },
      { id: 4, sequence: ["?", 6, 8, 10, 12], missingNumber: 4, options: [2, 4, 6], color: "#EAB308" },
      { id: 5, sequence: [10, "?", 14, 16, 18], missingNumber: 12, options: [11, 12, 13], color: "#EC4899" },
      { id: 6, sequence: [3, 6, "?", 12, 15], missingNumber: 9, options: [8, 9, 10], color: "#8B5CF6" },
      { id: 7, sequence: [1, 2, 3, "?", 5], missingNumber: 4, options: [3, 4, 6], color: "#F59E0B" },
      { id: 8, sequence: [8, 10, 12, "?", 16], missingNumber: 14, options: [13, 14, 15], color: "#14B8A6" },
      { id: 9, sequence: ["?", 4, 6, 8, 10], missingNumber: 2, options: [1, 2, 3], color: "#06B6D4" },
      { id: 10, sequence: [5, "?", 15, 20], missingNumber: 10, options: [8, 10, 12], color: "#A855F7" },
      { id: 11, sequence: [11, 12, "?", 14, 15], missingNumber: 13, options: [12, 13, 14], color: "#EF4444" },
      { id: 12, sequence: [2, 4, 6, 8, "?"], missingNumber: 10, options: [9, 10, 12], color: "#22C55E" },
      { id: 13, sequence: [1, 4, "?", 10, 13], missingNumber: 7, options: [5, 7, 9], color: "#EC4899" },
      { id: 14, sequence: [6, 8, "?", 12, 14], missingNumber: 10, options: [9, 10, 11], color: "#3B82F6" },
      { id: 15, sequence: [15, "?", 17, 18, 19], missingNumber: 16, options: [14, 16, 20], color: "#F97316" }
    ],
    en: [
      { id: 1, sequence: [2, 4, "?", 8, 10], missingNumber: 6, options: [4, 6, 8], color: "#EF4444" },
      { id: 2, sequence: [5, 10, "?", 20], missingNumber: 15, options: [12, 15, 18], color: "#10B981" },
