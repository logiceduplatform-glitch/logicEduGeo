// src/components/games/exercises_4_5_1/FindMissingNumberGame.jsx - Age 4-5 override
...
export default function FindMissingNumberGame({ lang = "el", onComplete, difficulty = 3 }) {
  ...
  const sequencesData = {
    el: [
      { id: 1, sequence: [1, 2, "?", 4, 5], missingNumber: 3, options: [2, 3, 4], color: "#EF4444" },
      { id: 2, sequence: ["?", 2, 3, 4, 5], missingNumber: 1, options: [1, 2, 3], color: "#10B981" },
      { id: 3, sequence: [1, 2, 3, "?", 5], missingNumber: 4, options: [3, 4, 5], color: "#3B82F6" },
      { id: 4, sequence: [2, 3, 4, 5, "?"], missingNumber: 6, options: [5, 6, 7], color: "#EAB308" },
      { id: 5, sequence: [1, "?", 3, 4, 5], missingNumber: 2, options: [1, 2, 3], color: "#EC4899" },
      { id: 6, sequence: [3, 4, "?", 6, 7], missingNumber: 5, options: [4, 5, 6], color: "#8B5CF6" },
      { id: 7, sequence: [5, 6, 7, "?", 9], missingNumber: 8, options: [7, 8, 9], color: "#F59E0B" },
      { id: 8, sequence: ["?", 4, 5, 6, 7], missingNumber: 3, options: [2, 3, 4], color: "#14B8A6" },
      { id: 9, sequence: [6, 7, 8, 9, "?"], missingNumber: 10, options: [8, 9, 10], color: "#06B6D4" },
      { id: 10, sequence: [1, 2, "?", 4], missingNumber: 3, options: [2, 3, 5], color: "#A855F7" },
      { id: 11, sequence: ["?", 3, 4, 5], missingNumber: 2, options: [1, 2, 3], color: "#EF4444" },
      { id: 12, sequence: [4, "?", 6, 7], missingNumber: 5, options: [4, 5, 6], color: "#10B981" },
      { id: 13, sequence: [7, 8, "?", 10], missingNumber: 9, options: [8, 9, 10], color: "#3B82F6" },
      { id: 14, sequence: [2, "?", 4, 5, 6], missingNumber: 3, options: [2, 3, 4], color: "#EAB308" },
      { id: 15, sequence: [5, 6, "?", 8], missingNumber: 7, options: [6, 7, 8], color: "#EC4899" }
    ],
    en: [
      { id: 1, sequence: [1, 2, "?", 4, 5], missingNumber: 3, options: [2, 3, 4], color: "#EF4444" },
      { id: 2, sequence: ["?", 2, 3, 4, 5], missingNumber: 1, options: [1, 2, 3], color: "#10B981" },
