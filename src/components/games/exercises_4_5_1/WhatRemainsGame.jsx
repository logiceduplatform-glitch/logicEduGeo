// src/components/games/exercises_4_5_1/WhatRemainsGame.jsx - Age 4-5 override
...
export default function WhatRemainsGame({ lang = "el", onComplete, difficulty = 3 }) {
  ...
  const subtractionsData = {
    el: [
      { id: 1, emoji: "🍎", name: "μήλα", initial: 3, remove: 1, remaining: 2, options: [1, 2, 3], color: "#EF4444" },
      { id: 2, emoji: "🍌", name: "μπανάνες", initial: 4, remove: 2, remaining: 2, options: [1, 2, 3], color: "#EAB308" },
      { id: 3, emoji: "⭐", name: "αστέρια", initial: 5, remove: 2, remaining: 3, options: [2, 3, 4], color: "#F59E0B" },
      { id: 4, emoji: "🎈", name: "μπαλόνια", initial: 3, remove: 2, remaining: 1, options: [1, 2, 3], color: "#EC4899" },
      { id: 5, emoji: "🍪", name: "μπισκότα", initial: 4, remove: 1, remaining: 3, options: [2, 3, 4], color: "#78350F" },
      { id: 6, emoji: "🐟", name: "ψάρια", initial: 5, remove: 3, remaining: 2, options: [1, 2, 3], color: "#06B6D4" },
      { id: 7, emoji: "🍓", name: "φραουλίτσες", initial: 4, remove: 3, remaining: 1, options: [1, 2, 3], color: "#EF4444" },
      { id: 8, emoji: "🌸", name: "λουλούδια", initial: 5, remove: 1, remaining: 4, options: [3, 4, 5], color: "#A855F7" },
      { id: 9, emoji: "🦋", name: "πεταλούδες", initial: 3, remove: 1, remaining: 2, options: [1, 2, 3], color: "#8B5CF6" },
      { id: 10, emoji: "🍬", name: "γλυκά", initial: 5, remove: 4, remaining: 1, options: [1, 2, 3], color: "#EC4899" },
      { id: 11, emoji: "🐣", name: "κοτάκια", initial: 4, remove: 2, remaining: 2, options: [1, 2, 3], color: "#EAB308" },
      { id: 12, emoji: "🎵", name: "νότες", initial: 5, remove: 2, remaining: 3, options: [2, 3, 4], color: "#06B6D4" },
      { id: 13, emoji: "🌈", name: "ουράνια τόξα", initial: 3, remove: 2, remaining: 1, options: [1, 2, 3], color: "#EC4899" },
      { id: 14, emoji: "🧸", name: "αρκουδάκια", initial: 4, remove: 1, remaining: 3, options: [2, 3, 4], color: "#F59E0B" },
      { id: 15, emoji: "🎀", name: "φιόγκες", initial: 5, remove: 3, remaining: 2, options: [1, 2, 3], color: "#EC4899" }
    ],
    en: [
      { id: 1, emoji: "🍎", name: "apples", initial: 3, remove: 1, remaining: 2, options: [1, 2, 3], color: "#EF4444" },
      { id: 2, emoji: "🍌", name: "bananas", initial: 4, remove: 2, remaining: 2, options: [1, 2, 3], color: "#EAB308" },
      { id: 3, emoji: "⭐", name: "stars", initial: 5, remove: 2, remaining: 3, options: [2, 3, 4], color: "#F59E0B" },
      { id: 4, emoji: "🎈", name: "balloons", initial: 3, remove: 2, remaining: 1, options: [1, 2, 3], color: "#EC4899" },
      { id: 5, emoji: "🍪", name: "cookies", initial: 4, remove: 1, remaining: 3, options: [2, 3, 4], color: "#78350F" },
      { id: 6, emoji: "🐟", name: "fish", initial: 5, remove: 3, remaining: 2, options: [1, 2, 3], color: "#06B6D4" },
      { id: 7, emoji: "🍓", name: "strawberries", initial: 4, remove: 3, remaining: 1, options: [1, 2, 3], color: "#EF4444" },
      { id: 8, emoji: "🌸", name: "flowers", initial: 5, remove: 1, remaining: 4, options: [3, 4, 5], color: "#A855F7" },
      { id: 9, emoji: "🦋", name: "butterflies", initial: 3, remove: 1, remaining: 2, options: [1, 2, 3], color: "#8B5CF6" },
      { id: 10, emoji: "🍬", name: "candies", initial: 5, remove: 4, remaining: 1, options: [1, 2, 3], color: "#EC4899" },
      { id: 11, emoji: "🐣", name: "chicks", initial: 4, remove: 2, remaining: 2, options: [1, 2, 3], color: "#EAB308" },
      { id: 12, emoji: "🎵", name: "notes", initial: 5, remove: 2, remaining: 3, options: [2, 3, 4], color: "#06B6D4" },
      { id: 13, emoji: "🌈", name: "rainbows", initial: 3, remove: 2, remaining: 1, options: [1, 2, 3], color: "#EC4899" },
      { id: 14, emoji: "🧸", name: "teddy bears", initial: 4, remove: 1, remaining: 3, options: [2, 3, 4], color: "#F59E0B" },
      { id: 15, emoji: "🎀", name: "ribbons", initial: 5, remove: 3, remaining: 2, options: [1, 2, 3], color: "#EC4899" }
    ]
  };
