// src/components/games/exercises_7_8_1/FindMissingNumberGame.jsx
...
export default function FindMissingNumberGame({ lang = "el", onComplete, difficulty = 3 }) {
  ...
  const sequencesData = {
    el: [
      { id: 1, sequence: [5, 10, 15, "?", 25], missingNumber: 20, options: [18, 20, 22], color: "#EF4444" },
      { id: 2, sequence: [2, 4, 6, 8, "?"], missingNumber: 10, options: [9, 10, 12], color: "#10B981" },
      { id: 3, sequence: [3, 6, 9, "?", 15], missingNumber: 12, options: [10, 12, 14], color: "#3B82F6" },
      { id: 4, sequence: [10, 20, "?", 40, 50], missingNumber: 30, options: [25, 30, 35], color: "#EAB308" },
      { id: 5, sequence: [4, 8, 12, "?", 20], missingNumber: 16, options: [14, 16, 18], color: "#EC4899" },
      { id: 6, sequence: ["?", 14, 21, 28, 35], missingNumber: 7, options: [5, 7, 10], color: "#8B5CF6" },
      { id: 7, sequence: [1, 4, 9, "?", 25], missingNumber: 16, options: [14, 16, 20], color: "#F59E0B" },
      { id: 8, sequence: [6, 12, "?", 24, 30], missingNumber: 18, options: [15, 18, 21], color: "#14B8A6" },
      { id: 9, sequence: [11, 22, 33, "?", 55], missingNumber: 44, options: [40, 44, 48], color: "#06B6D4" },
      { id: 10, sequence: [5, 10, "?", 20, 25], missingNumber: 15, options: [12, 15, 18], color: "#A855F7" },
      { id: 11, sequence: [8, 16, 24, "?", 40], missingNumber: 32, options: [28, 32, 36], color: "#22C55E" },
      { id: 12, sequence: ["?", 9, 12, 15, 18], missingNumber: 6, options: [3, 6, 9], color: "#F97316" },
      { id: 13, sequence: [7, 14, "?", 28, 35], missingNumber: 21, options: [18, 21, 24], color: "#EC4899" },
      { id: 14, sequence: [15, 20, 25, "?", 35], missingNumber: 30, options: [28, 30, 32], color: "#06B6D4" },
      { id: 15, sequence: [3, 6, "?", 12, 15], missingNumber: 9, options: [7, 9, 11], color: "#8B5CF6" }
    ],
    en: [
      { id: 1, sequence: [5, 10, 15, "?", 25], missingNumber: 20, options: [18, 20, 22], color: "#EF4444" },
      { id: 2, sequence: [2, 4, 6, 8, "?"], missingNumber: 10, options: [9, 10, 12], color: "#10B981" },
