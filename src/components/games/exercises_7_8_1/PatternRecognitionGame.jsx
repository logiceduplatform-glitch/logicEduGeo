// src/components/games/exercises_7_8_1/PatternRecognitionGame.jsx
...
export default function PatternRecognitionGame({ lang = "el", onComplete }) {
  ...
  const roundsData = {
    el: [
      ...
      { id: 2, question: "Ποιο έρχεται μετά;", pattern: ["⭐", "🌙", "☀️", "⭐", "🌙"], correctAnswer: "☀️", options: ["⭐", "☀️", "🌙"], color: "#EAB308" },
      { id: 3, question: "Ποιο έρχεται μετά;", pattern: ["🐶", "🐱", "🐦", "🐶", "🐱"], correctAnswer: "🐦", options: ["🐶", "🐦", "🐱"], color: "#3B82F6" },
      { id: 4, question: "Ποιο έρχεται μετά;", pattern: ["❤️", "💙", "💚", "💛", "❤️", "💙", "💚"], correctAnswer: "💛", options: ["❤️", "💛", "💚"], color: "#EC4899" },
      { id: 5, question: "Ποιο έρχεται μετά;", pattern: ["🍎", "🍌", "🍊", "🍇", "🍎", "🍌", "🍊"], correctAnswer: "🍇", options: ["🍎", "🍇", "🍊"], color: "#22C55E" },
      ...
      { id: 8, question: "Ποιο έρχεται μετά;", pattern: ["🟡", "🟢", "🔵", "🟣", "🟡", "🟢", "🔵"], correctAnswer: "🟣", options: ["🟡", "🟣", "🔵"], color: "#8B5CF6" },
      { id: 9, question: "Ποιο έρχεται μετά;", pattern: ["🍓", "🍇", "🍊", "🍋", "🍓", "🍇", "🍊"], correctAnswer: "🍋", options: ["🍓", "🍋", "🍊"], color: "#F97316" },
      { id: 10, question: "Ποιο έρχεται μετά;", pattern: ["☀️", "🌧️", "☁️", "🌈", "☀️", "🌧️", "☁️"], correctAnswer: "🌈", options: ["☀️", "🌈", "🌧️"], color: "#14B8A6" },
      { id: 11, question: "Ποιο έρχεται μετά;", pattern: ["🐸", "🦋", "🐛", "🐞", "🐸", "🦋", "🐛"], correctAnswer: "🐞", options: ["🐸", "🐞", "🐛"], color: "#22C55E" },
      { id: 12, question: "Ποιο έρχεται μετά;", pattern: ["🐣", "🐥", "🐔", "🦆", "🐣", "🐥", "🐔"], correctAnswer: "🦆", options: ["🐣", "🦆", "🐔"], color: "#EAB308" },
      { id: 13, question: "Ποιο έρχεται μετά;", pattern: ["🎵", "🎶", "🔔", "🥁", "🎵", "🎶", "🔔"], correctAnswer: "🥁", options: ["🎵", "🥁", "🔔"], color: "#EC4899" },
      { id: 14, question: "Ποιο έρχεται μετά;", pattern: ["🌺", "🍀", "🌻", "🌼", "🌺", "🍀", "🌻"], correctAnswer: "🌼", options: ["🌺", "🌼", "🌻"], color: "#06B6D4" },
      { id: 15, question: "Ποιο έρχεται μετά;", pattern: ["🐠", "🦀", "🐙", "🦑", "🐠", "🦀", "🐙"], correctAnswer: "🦑", options: ["🐠", "🦑", "🐙"], color: "#3B82F6" }
    ],
    en: [
      { id: 1, question: "What comes next?", pattern: ["🔴", "🔵", "🟢", "🟡", "🔴", "🔵", "🟢"], correctAnswer: "🟡", options: ["🔴", "🟡", "🟢"], color: "#EF4444" },
      { id: 2, question: "What comes next?", pattern: ["⭐", "🌙", "☀️", "⭐", "🌙"], correctAnswer: "☀️", options: ["⭐", "☀️", "🌙"], color: "#EAB308" },
      { id: 3, question: "What comes next?", pattern: ["🐶", "🐱", "🐦", "🐶", "🐱"], correctAnswer: "🐦", options: ["🐶", "🐦", "🐱"], color: "#3B82F6" },
      { id: 4, question: "What comes next?", pattern: ["❤️", "💙", "💚", "💛", "❤️", "💙", "💚"], correctAnswer: "💛", options: ["❤️", "💛", "💚"], color: "#EC4899" },
      { id: 5, question: "What comes next?", pattern: ["🍎", "🍌", "🍊", "🍇", "🍎", "🍌", "🍊"], correctAnswer: "🍇", options: ["🍎", "🍇", "🍊"], color: "#22C55E" },
      ...
      { id: 8, question: "What comes next?", pattern: ["🟡", "🟢", "🔵", "🟣", "🟡", "🟢", "🔵"], correctAnswer: "🟣", options: ["🟡", "🟣", "🔵"], color: "#8B5CF6" },
      { id: 9, question: "What comes next?", pattern: ["🍓", "🍇", "🍊", "🍋", "🍓", "🍇", "🍊"], correctAnswer: "🍋", options: ["🍓", "🍋", "🍊"], color: "#F97316" },
      { id: 10, question: "What comes next?", pattern: ["☀️", "🌧️", "☁️", "🌈", "☀️", "🌧️", "☁️"], correctAnswer: "🌈", options: ["☀️", "🌈", "🌧️"], color: "#14B8A6" },
      { id: 11, question: "What comes next?", pattern: ["🐸", "🦋", "🐛", "🐞", "🐸", "🦋", "🐛"], correctAnswer: "🐞", options: ["🐸", "🐞", "🐛"], color: "#22C55E" },
      { id: 12, question: "What comes next?", pattern: ["🐣", "🐥", "🐔", "🦆", "🐣", "🐥", "🐔"], correctAnswer: "🦆", options: ["🐣", "🦆", "🐔"], color: "#EAB308" },
      { id: 13, question: "What comes next?", pattern: ["🎵", "🎶", "🔔", "🥁", "🎵", "🎶", "🔔"], correctAnswer: "🥁", options: ["🎵", "🥁", "🔔"], color: "#EC4899" },
      { id: 14, question: "What comes next?", pattern: ["🌺", "🍀", "🌻", "🌼", "🌺", "🍀", "🌻"], correctAnswer: "🌼", options: ["🌺", "🌼", "🌻"], color: "#06B6D4" },
      { id: 15, question: "What comes next?", pattern: ["🐠", "🦀", "🐙", "🦑", "🐠", "🦀", "🐙"], correctAnswer: "🦑", options: ["🐠", "🦑", "🐙"], color: "#3B82F6" }
    ]
  };
