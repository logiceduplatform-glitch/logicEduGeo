// src/components/games/exercises_7_8_1/WhatRemainsGame.jsx
...
export default function WhatRemainsGame({ lang = "el", onComplete, difficulty = 3 }) {
  ...
  const subtractionsData = {
    el: [
      { id: 1, emoji: "🍎", name: "μήλα", initial: 15, remove: 7, remaining: 8, options: [7, 8, 9], color: "#EF4444" },
      { id: 2, emoji: "🍌", name: "μπανάνες", initial: 12, remove: 5, remaining: 7, options: [6, 7, 8], color: "#EAB308" },
      { id: 3, emoji: "⭐", name: "αστέρια", initial: 20, remove: 8, remaining: 12, options: [11, 12, 13], color: "#F59E0B" },
      { id: 4, emoji: "🎈", name: "μπαλόνια", initial: 14, remove: 6, remaining: 8, options: [7, 8, 9], color: "#10B981" },
      { id: 5, emoji: "🍪", name: "μπισκότα", initial: 18, remove: 9, remaining: 9, options: [8, 9, 10], color: "#EC4899" },
      { id: 6, emoji: "🐟", name: "ψάρια", initial: 16, remove: 7, remaining: 9, options: [8, 9, 10], color: "#A855F7" },
      { id: 7, emoji: "🍓", name: "φράουλες", initial: 13, remove: 8, remaining: 5, options: [4, 5, 6], color: "#3B82F6" },
      { id: 8, emoji: "🌸", name: "λουλούδια", initial: 17, remove: 9, remaining: 8, options: [7, 8, 9], color: "#F97316" },
      { id: 9, emoji: "🦋", name: "πεταλούδες", initial: 11, remove: 4, remaining: 7, options: [6, 7, 8], color: "#14B8A6" },
      { id: 10, emoji: "🍬", name: "καραμέλες", initial: 20, remove: 12, remaining: 8, options: [7, 8, 9], color: "#8B5CF6" },
      { id: 11, emoji: "🐣", name: "κοτοπουλάκια", initial: 15, remove: 6, remaining: 9, options: [8, 9, 10], color: "#22C55E" },
      { id: 12, emoji: "🎵", name: "νότες", initial: 19, remove: 11, remaining: 8, options: [7, 8, 9], color: "#EC4899" },
      { id: 13, emoji: "🌈", name: "κραγιόνια", initial: 14, remove: 5, remaining: 9, options: [8, 9, 10], color: "#06B6D4" },
      { id: 14, emoji: "🧸", name: "αρκουδάκια", initial: 16, remove: 9, remaining: 7, options: [6, 7, 8], color: "#F59E0B" },
      { id: 15, emoji: "🎀", name: "φιόγκα", initial: 18, remove: 10, remaining: 8, options: [7, 8, 9], color: "#A855F7" }
    ],
    en: [
      { id: 1, emoji: "🍎", name: "apples", initial: 15, remove: 7, remaining: 8, options: [7, 8, 9], color: "#EF4444" },
      { id: 2, emoji: "🍌", name: "bananas", initial: 12, remove: 5, remaining: 7, options: [6, 7, 8], color: "#EAB308" },
      { id: 3, emoji: "⭐", name: "stars", initial: 20, remove: 8, remaining: 12, options: [11, 12, 13], color: "#F59E0B" },
      { id: 4, emoji: "🎈", name: "balloons", initial: 14, remove: 6, remaining: 8, options: [7, 8, 9], color: "#10B981" },
      { id: 5, emoji: "🍪", name: "cookies", initial: 18, remove: 9, remaining: 9, options: [8, 9, 10], color: "#EC4899" },
      { id: 6, emoji: "🐟", name: "fish", initial: 16, remove: 7, remaining: 9, options: [8, 9, 10], color: "#A855F7" },
      { id: 7, emoji: "🍓", name: "strawberries", initial: 13, remove: 8, remaining: 5, options: [4, 5, 6], color: "#3B82F6" },
      { id: 8, emoji: "🌸", name: "flowers", initial: 17, remove: 9, remaining: 8, options: [7, 8, 9], color: "#F97316" },
      { id: 9, emoji: "🦋", name: "butterflies", initial: 11, remove: 4, remaining: 7, options: [6, 7, 8], color: "#14B8A6" },
      { id: 10, emoji: "🍬", name: "candies", initial: 20, remove: 12, remaining: 8, options: [7, 8, 9], color: "#8B5CF6" },
      { id: 11, emoji: "🐣", name: "chicks", initial: 15, remove: 6, remaining: 9, options: [8, 9, 10], color: "#22C55E" },
      { id: 12, emoji: "🎵", name: "notes", initial: 19, remove: 11, remaining: 8, options: [7, 8, 9], color: "#EC4899" },
      { id: 13, emoji: "🌈", name: "crayons", initial: 14, remove: 5, remaining: 9, options: [8, 9, 10], color: "#06B6D4" },
      { id: 14, emoji: "🧸", name: "bears", initial: 16, remove: 9, remaining: 7, options: [6, 7, 8], color: "#F59E0B" },
      { id: 15, emoji: "🎀", name: "ribbons", initial: 18, remove: 10, remaining: 8, options: [7, 8, 9], color: "#A855F7" }
    ]
  };
