// src/components/games/exercises_7_8_1/WhoWaitsInLineGame.jsx
    ...
    el: [
      {
        id: 1,
        scenario: {
          description: "Τέσσερα παιδιά περιμένουν τον εξοπλισμό του επιστημονικού εργαστηρίου.",
      ...
      },
      {
        id: 2,
        scenario: {
          description: "Παιδιά περιμένουν τη σειρά τους να παρουσιάσουν το έργο τους.",
          context: "Στην τάξη"
        },
        correctAnswer: "child3",
        question: "Ποιο παιδί περιμένει υπομονετικά;",
        children: [
          { id: "child1", emoji: "😤", behavior: "Τραβάει το παιδί που παρουσιάζει", isPatient: false },
          { id: "child2", emoji: "😡", behavior: "Φωνάζει 'Είναι η σειρά μου!'", isPatient: false },
          { id: "child3", emoji: "😌", behavior: "Κάθεται και περιμένει", isPatient: true },
      ...
      },
      {
        id: 3,
        scenario: {
          description: "Παιδιά περιμένουν να δανειστούν ένα δημοφιλές βιβλίο.",
        ...
        children: [
          ...
          { id: "child3", emoji: "😫", behavior: "Φωνάζει 'Πεινάω να το διαβάσω!'", isPatient: false },
      ...
      },
      {
        id: 4,
        scenario: {
          description: "Παιδιά περιμένουν για το γήπεδο μπάσκετ.",
          context: "Στο γήπεδο"
        },
        ...
        children: [
          ...
          { id: "child3", emoji: "😒", behavior: "Παραπονιέται για την αργοπορία", isPatient: false },
      ...
      },
      {
        id: 5,
        scenario: {
          description: "Παιδιά περιμένουν να χρησιμοποιήσουν τον υπολογιστή της τάξης.",
          context: "Στην τάξη"
        },
        correctAnswer: "child2",
        question: "Ποιο παιδί περιμένει υπομονετικά;",
        children: [
          ...
          { id: "child4", emoji: "😤", behavior: "Σπρώχνει τα άλλα παιδιά", isPatient: false }
        ]
      },
      {
        id: 6,
        scenario: {
          description: "Παιδιά περιμένουν στην ουρά της σχολικής καντίνας.",
        ...
        children: [
          ...
          { id: "child4", emoji: "😒", behavior: "Τραβάει τον υπεύθυνο", isPatient: false }
        ]
      },
      {
        id: 7,
        scenario: {
          description: "Παιδιά περιμένουν για τα όργανα του μουσικού δωματίου.",
          context: "Στη μουσική"
        },
        correctAnswer: "child1",
        question: "Ποιο παιδί περιμένει υπομονετικά;",
        children: [
          ...
          { id: "child2", emoji: "😤", behavior: "Σπρώχνει για να πάρει πρώτο", isPatient: false },
      ...
      },
      {
        id: 8,
        scenario: {
          description: "Παιδιά περιμένουν τη σειρά τους σε σκυλάδρο.",
          context: "Στη γυμναστική"
        },
        correctAnswer: "child4",
        question: "Ποιο παιδί περιμένει υπομονετικά;",
        children: [
          { id: "child1", emoji: "😤", behavior: "Αρπάζει τη σειρά", isPatient: false },
          { id: "child2", emoji: "😠", behavior: "Λέει 'Είναι δική μου η σειρά!'", isPatient: false },
      ...
      },
      {
        id: 9,
        scenario: {
          description: "Παιδιά περιμένουν να μιλήσουν στη δασκάλα.",
          context: "Στην τάξη"
        },
        correctAnswer: "child2",
        question: "Ποιο παιδί περιμένει υπομονετικά;",
        children: [
          { id: "child1", emoji: "😤", behavior: "Σπρώχνει τα άλλα παιδιά", isPatient: false },
          { id: "child2", emoji: "😊", behavior: "Στέκεται ήρεμα στη σειρά", isPatient: true },
          { id: "child3", emoji: "😫", behavior: "Φωνάζει συνεχώς", isPatient: false },
      ...
      },
      {
        id: 10,
        scenario: {
          description: "Παιδιά περιμένουν το σχολικό λεωφορείο μετά από εκδρομή.",
          context: "Στην εκδρομή"
        },
        correctAnswer: "child3",
        question: "Ποιο παιδί περιμένει υπομονετικά;",
        children: [
          { id: "child1", emoji: "😤", behavior: "Τρέχει στο λεωφορείο", isPatient: false },
          { id: "child2", emoji: "😠", behavior: "Φωνάζει στον οδηγό", isPatient: false },
          { id: "child3", emoji: "😌", behavior: "Περιμένει με υπομονή", isPatient: true },
      ...
      },
      {
        id: 11,
        scenario: {
          description: "Παιδιά περιμένουν τα αποτελέσματα του διαγωνίσματος.",
          context: "Στην τάξη"
        },
        correctAnswer: "child1",
        question: "Ποιο παιδί περιμένει υπομονετικά;",
        children: [
          { id: "child1", emoji: "😊", behavior: "Κάθεται και περιμένει ήσυχα", isPatient: true },
          { id: "child2", emoji: "😤", behavior: "Ζητάει τα αποτελέσματα συνεχώς", isPatient: false },
          { id: "child3", emoji: "😫", behavior: "Κλαίει από άγχος", isPatient: false },
      ...
      },
      {
        id: 12,
        scenario: {
          description: "Παιδιά περιμένουν για τα εικαστικά υλικά.",
          context: "Στα εικαστικά"
        },
        correctAnswer: "child4",
        question: "Ποιο παιδί περιμένει υπομονετικά;",
        children: [
          { id: "child1", emoji: "😠", behavior: "Αρπάζει από τα χέρια άλλου", isPatient: false },
          { id: "child2", emoji: "😤", behavior: "Φωνάζει 'Εγώ πρώτα!'", isPatient: false },
          { id: "child3", emoji: "😒", behavior: "Παραπονιέται για την αναμονή", isPatient: false },
          { id: "child4", emoji: "😌", behavior: "Περιμένει τη σειρά του", isPatient: true }
        ]
      },
      {
        id: 13,
        scenario: {
          description: "Παιδιά περιμένουν για πρόβες του σχολικού θεατρικού.",
          context: "Στην αίθουσα"
        },
        correctAnswer: "child2",
        question: "Ποιο παιδί περιμένει υπομονετικά;",
        children: [
          { id: "child1", emoji: "😤", behavior: "Μπαίνει στη σκηνή χωρίς σειρά", isPatient: false },
          { id: "child2", emoji: "😊", behavior: "Κάθεται και περιμένει", isPatient: true },
          { id: "child3", emoji: "😫", behavior: "Φωνάζει 'Πότε θα έρθει η σειρά μου;'", isPatient: false },
          { id: "child4", emoji: "🙄", behavior: "Παραπονιέται", isPatient: false }
        ]
      },
      {
        id: 14,
        scenario: {
          description: "Παιδιά περιμένουν το μεσημεριανό τους στο κυλικείο.",
          context: "Στο κυλικείο"
        },
        correctAnswer: "child3",
        question: "Ποιο παιδί περιμένει υπομονετικά;",
        children: [
          { id: "child1", emoji: "😠", behavior: "Σπρώχνει την ουρά", isPatient: false },
          { id: "child2", emoji: "😤", behavior: "Προσπαθεί να περάσει μπροστά", isPatient: false },
          { id: "child3", emoji: "😌", behavior: "Στέκεται υπομονετικά στη σειρά", isPatient: true },
      ...
      },
      {
        id: 15,
        scenario: {
          description: "Παιδιά περιμένουν για λωρίδα στο κολυμβητήριο.",
          context: "Στο κολυμβητήριο"
        },
        correctAnswer: "child1",
        question: "Ποιο παιδί περιμένει υπομονετικά;",
        children: [
          { id: "child1", emoji: "😊", behavior: "Περιμένει ήρεμα στη σειρά", isPatient: true },
          { id: "child2", emoji: "😤", behavior: "Μπαίνει στη λωρίδα χωρίς σειρά", isPatient: false },
          { id: "child3", emoji: "😠", behavior: "Φωνάζει στον κολυμβητή", isPatient: false },
          { id: "child4", emoji: "🏃", behavior: "Τρέχει να προλάβει", isPatient: false }
        ]
      }
    ],
    en: [
      {
        id: 1,
        scenario: {
          description: "Four children are waiting for the science lab equipment.",
          context: "In the lab"
        },
        correctAnswer: "child2",
      ...
      },
      {
        id: 2,
        scenario: {
          description: "Children are waiting for their turn to present their project.",
          context: "In the classroom"
        },
        correctAnswer: "child3",
        question: "Which child is waiting patiently?",
        children: [
          { id: "child1", emoji: "😤", behavior: "Pulling the presenting child", isPatient: false },
          { id: "child2", emoji: "😡", behavior: "Yelling 'It's my turn!'", isPatient: false },
          { id: "child3", emoji: "😌", behavior: "Sitting and waiting", isPatient: true },
      ...
      },
      {
        id: 3,
        scenario: {
          description: "Children are waiting to borrow a popular book.",
        ...
        children: [
          ...
          { id: "child3", emoji: "😫", behavior: "Yelling 'I'm dying to read it!'", isPatient: false },
      ...
      },
      {
        id: 4,
        scenario: {
          description: "Children are waiting for the basketball court.",
        ...
        children: [
          ...
          { id: "child3", emoji: "😒", behavior: "Complaining about the wait", isPatient: false },
      ...
      },
      {
        id: 5,
        scenario: {
          description: "Children are waiting to use the class computer.",
          context: "In the classroom"
        },
        correctAnswer: "child2",
        question: "Which child is waiting patiently?",
        children: [
          ...
          { id: "child4", emoji: "😤", behavior: "Pushing other children", isPatient: false }
        ]
      },
      {
        id: 6,
        scenario: {
          description: "Children are waiting in line for the school cafeteria.",
        ...
        children: [
          ...
          { id: "child4", emoji: "😒", behavior: "Pulling the staff", isPatient: false }
        ]
      },
      {
        id: 7,
        scenario: {
          description: "Children are waiting for the music room instruments.",
          context: "In music class"
        },
        correctAnswer: "child1",
        question: "Which child is waiting patiently?",
        children: [
          { id: "child1", emoji: "😊", behavior: "Waiting for their turn", isPatient: true },
          { id: "child2", emoji: "😤", behavior: "Pushing to get one first", isPatient: false },
      ...
      },
      {
        id: 8,
        scenario: {
          description: "Children are waiting for their turn in a relay race.",
          context: "In gym class"
        },
        correctAnswer: "child4",
        question: "Which child is waiting patiently?",
        children: [
          { id: "child1", emoji: "😤", behavior: "Grabbing the baton early", isPatient: false },
          { id: "child2", emoji: "😠", behavior: "Saying 'It's my turn!'", isPatient: false },
      ...
      },
      {
        id: 9,
        scenario: {
          description: "Children are waiting to speak to the teacher.",
          context: "In the classroom"
        },
        correctAnswer: "child2",
        question: "Which child is waiting patiently?",
        children: [
          { id: "child1", emoji: "😤", behavior: "Pushing other children", isPatient: false },
          { id: "child2", emoji: "😊", behavior: "Standing calmly in line", isPatient: true },
          { id: "child3", emoji: "😫", behavior: "Yelling continuously", isPatient: false },
      ...
      },
      {
        id: 10,
        scenario: {
          description: "Children are waiting for the school bus after a trip.",
          context: "On the trip"
        },
        correctAnswer: "child3",
        question: "Which child is waiting patiently?",
        children: [
          { id: "child1", emoji: "😤", behavior: "Running to the bus", isPatient: false },
          { id: "child2", emoji: "😠", behavior: "Yelling at the driver", isPatient: false },
          { id: "child3", emoji: "😌", behavior: "Waiting patiently", isPatient: true },
      ...
      },
      {
        id: 11,
        scenario: {
          description: "Children are waiting to get their test results.",
          context: "In the classroom"
        },
        correctAnswer: "child1",
        question: "Which child is waiting patiently?",
        children: [
          { id: "child1", emoji: "😊", behavior: "Sitting and waiting quietly", isPatient: true },
          { id: "child2", emoji: "😤", behavior: "Asking for results constantly", isPatient: false },
          { id: "child3", emoji: "😫", behavior: "Crying from anxiety", isPatient: false },
      ...
      },
      {
        id: 12,
        scenario: {
          description: "Children are waiting to use the art supplies.",
          context: "In art class"
        },
        correctAnswer: "child4",
        question: "Which child is waiting patiently?",
        children: [
          { id: "child1", emoji: "😠", behavior: "Grabbing from someone's hands", isPatient: false },
          { id: "child2", emoji: "😤", behavior: "Yelling 'Me first!'", isPatient: false },
          { id: "child3", emoji: "😒", behavior: "Complaining about the wait", isPatient: false },
          { id: "child4", emoji: "😌", behavior: "Waiting for their turn", isPatient: true }
        ]
      },
      {
        id: 13,
        scenario: {
          description: "Children are waiting for the school play rehearsal.",
          context: "In the hall"
        },
        correctAnswer: "child2",
        question: "Which child is waiting patiently?",
        children: [
          { id: "child1", emoji: "😤", behavior: "Going on stage out of turn", isPatient: false },
          { id: "child2", emoji: "😊", behavior: "Sitting and waiting", isPatient: true },
          { id: "child3", emoji: "😫", behavior: "Yelling 'When's my turn?'", isPatient: false },
          { id: "child4", emoji: "🙄", behavior: "Complaining", isPatient: false }
        ]
      },
      {
        id: 14,
        scenario: {
          description: "Children are waiting for their lunch in the canteen.",
          context: "In the canteen"
        },
        correctAnswer: "child3",
        question: "Which child is waiting patiently?",
        children: [
          { id: "child1", emoji: "😠", behavior: "Pushing the line", isPatient: false },
          { id: "child2", emoji: "😤", behavior: "Trying to cut in line", isPatient: false },
          { id: "child3", emoji: "😌", behavior: "Standing patiently in line", isPatient: true },
          { id: "child4", emoji: "😒", behavior: "Pulling the vendor", isPatient: false }
        ]
      },
      {
        id: 15,
        scenario: {
          description: "Children are waiting for the swimming pool lane.",
          context: "At the pool"
        },
        correctAnswer: "child1",
        question: "Which child is waiting patiently?",
        children: [
          { id: "child1", emoji: "😊", behavior: "Waiting calmly in line", isPatient: true },
          { id: "child2", emoji: "😤", behavior: "Getting in the lane out of turn", isPatient: false },
          { id: "child3", emoji: "😠", behavior: "Yelling at the swimmer", isPatient: false },
          { id: "child4", emoji: "🏃", behavior: "Running to get ahead", isPatient: false }
        ]
      }
    ]
