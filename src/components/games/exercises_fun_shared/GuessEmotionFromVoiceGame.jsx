// src/components/games/GuessEmotionFromVoiceGame.jsx
...
export default function GuessEmotionFromVoiceGame({ lang = "el", difficulty = 3, onComplete }) {
  ...
  const roundsData = {
    el: [
      {
        id: 1,
        text: "Γεια σου! Τι ωραία που είσαι εδώ!",
        correctEmotion: "happy",
        voiceSettings: { rate: 1.1, pitch: 1.3, volume: 1 },
        options: [
          { id: "happy", emoji: "😊", label: "Χαρούμενη" },
          { id: "sad", emoji: "😢", label: "Λυπημένη" },
          { id: "angry", emoji: "😠", label: "Θυμωμένη" }
        ]
      },
      {
        id: 2,
        text: "Δεν θέλω να παίξω μαζί σου.",
        correctEmotion: "sad",
        voiceSettings: { rate: 0.8, pitch: 0.8, volume: 0.7 },
        options: [
          { id: "happy", emoji: "😊", label: "Χαρούμενη" },
          { id: "sad", emoji: "😢", label: "Λυπημένη" },
          { id: "excited", emoji: "🤩", label: "Ενθουσιασμένη" }
        ]
      },
      {
        id: 3,
        text: "Δεν είναι δίκαιο! Είπες ψέματα!",
        correctEmotion: "angry",
        voiceSettings: { rate: 1.3, pitch: 1.4, volume: 1 },
        options: [
          { id: "angry", emoji: "😠", label: "Θυμωμένη" },
          { id: "happy", emoji: "😊", label: "Χαρούμενη" },
          { id: "calm", emoji: "😌", label: "Ήρεμη" }
        ]
      },
      {
        id: 4,
        text: "Ουάου! Αυτό είναι φανταστικό!",
        correctEmotion: "excited",
        voiceSettings: { rate: 1.2, pitch: 1.5, volume: 1 },
        options: [
          { id: "excited", emoji: "🤩", label: "Ενθουσιασμένη" },
          { id: "sad", emoji: "😢", label: "Λυπημένη" },
          { id: "bored", emoji: "😑", label: "Βαρεμένη" }
        ]
      },
      {
        id: 5,
        text: "Με πονάει πολύ το χέρι μου.",
        correctEmotion: "hurt",
        voiceSettings: { rate: 0.9, pitch: 0.9, volume: 0.8 },
        options: [
          { id: "hurt", emoji: "😣", label: "Πονεμένη" },
          { id: "happy", emoji: "😊", label: "Χαρούμενη" },
          { id: "excited", emoji: "🤩", label: "Ενθουσιασμένη" }
        ]
      },
      {
        ...
        options: [
          { id: "scared", emoji: "😨", label: "Φοβισμένη" },
          { id: "angry", emoji: "😠", label: "Θυμωμένη" },
          { id: "happy", emoji: "😊", label: "Χαρούμενη" }
        ]
      },
      {
        id: 7,
        text: "Είμαι τόσο περήφανος για τον εαυτό μου!",
        correctEmotion: "proud",
        voiceSettings: { rate: 1.0, pitch: 1.2, volume: 1 },
        options: [
          { id: "proud", emoji: "😎", label: "Περήφανη" },
          { id: "sad", emoji: "😢", label: "Λυπημένη" },
          { id: "scared", emoji: "😨", label: "Φοβισμένη" }
        ]
      },
      {
        id: 8,
        text: "Είμαι τόσο κουρασμένος. Θέλω να κοιμηθώ.",
        correctEmotion: "tired",
        voiceSettings: { rate: 0.7, pitch: 0.8, volume: 0.6 },
        options: [
          { id: "tired", emoji: "😴", label: "Κουρασμένη" },
          { id: "excited", emoji: "🤩", label: "Ενθουσιασμένη" },
          { id: "angry", emoji: "😠", label: "Θυμωμένη" }
        ]
      },
    ...
    en: [
      {
        id: 1,
        text: "Hi! It's so nice that you're here!",
        correctEmotion: "happy",
        voiceSettings: { rate: 1.1, pitch: 1.3, volume: 1 },
        options: [
      ...
      {
        id: 8,
        text: "I'm so tired. I want to sleep.",
        correctEmotion: "tired",
        voiceSettings: { rate: 0.7, pitch: 0.8, volume: 0.6 },
        options: [
      ...
      {
        id: 9,
        text: "I can't believe it! What a surprise!",
        correctEmotion: "surprised",
        voiceSettings: { rate: 1.2, pitch: 1.4, volume: 1 },
        options: [
