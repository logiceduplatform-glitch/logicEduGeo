// src/components/games/HowDoesItFeelGame.jsx
    ...
    el: [
      {
        ...
        scene: {
          emoji: "🎂🎈",
          description: "Το παιδί έχει γενέθλια με τούρτα και μπαλόνια!",
          character: "👦"
        },
        correctAnswer: "happy",
        question: "Πώς νιώθει;",
      ...
      },
      {
        ...
        scene: {
          emoji: "🧸💔",
          description: "Το αρκουδάκι του έσπασε και δεν μπορεί να παίξει μαζί του.",
          character: "👧"
        },
        correctAnswer: "sad",
        question: "Πώς νιώθει;",
      ...
      },
      {
        ...
        scene: {
          emoji: "👻🌙",
          description: "Ακούει παράξενους ήχους στο σκοτάδι τη νύχτα.",
          character: "👦"
        },
      ...
      },
      {
        ...
        scene: {
          emoji: "🎁✨",
          description: "Άνοιξε ένα δώρο έκπληξη και είναι ακριβώς αυτό που ήθελε!",
          character: "👦"
        },
      ...
      },
      {
        ...
        scene: {
          emoji: "🤕💊",
          description: "Έπεσε και χτύπησε το γόνατό του. Πονάει.",
          character: "👧"
        },
        correctAnswer: "hurt",
        question: "Πώς νιώθει;",
      ...
      },
      {
        ...
        scene: {
          emoji: "🏆⭐",
          description: "Κέρδισε το πρώτο βραβείο στον αγώνα!",
          character: "👦"
        },
        correctAnswer: "proud",
        question: "Πώς νιώθει;",
      ...
      },
      {
        ...
        scene: {
          emoji: "😴🛏️",
          description: "Είναι πολύ αργά και θέλει να πάει για ύπνο.",
          character: "👧"
        },
      ...
      },
      {
        ...
        scene: {
          emoji: "🎪🎉",
          description: "Είδε κάτι απίστευτο που δεν το περίμενε καθόλου!",
          character: "👦"
        },
      ...
      },
      {
        ...
        scene: {
          emoji: "❤️🤗",
          description: "Η μαμά του έδωσε ένα μεγάλο αγκάλιασμα!",
          character: "👧"
        },
        correctAnswer: "loved",
        question: "Πώς νιώθει;",
    ...
    en: [
      {
        ...
        scene: {
          emoji: "🎂🎈",
          description: "The child has a birthday with cake and balloons!",
          character: "👦"
        },
        correctAnswer: "happy",
      ...
      },
      {
        ...
        scene: {
          emoji: "🧸💔",
          description: "Their teddy bear broke and they can't play with it.",
          character: "👧"
        },
        correctAnswer: "sad",
        question: "How does it feel?",
      ...
      },
      {
        ...
        scene: {
          emoji: "👻🌙",
          description: "They hear strange noises in the dark at night.",
          character: "👦"
        },
        correctAnswer: "scared",
        question: "How does it feel?",
      ...
      },
      {
        ...
        scene: {
          emoji: "🎁✨",
          description: "They opened a surprise gift and it's exactly what they wanted!",
          character: "👦"
        },
        correctAnswer: "excited",
        question: "How does it feel?",
      ...
      },
      {
        ...
        scene: {
          emoji: "🤕💊",
          description: "They fell down and hurt their knee. It hurts.",
          character: "👧"
        },
        correctAnswer: "hurt",
        question: "How does it feel?",
      ...
      },
      {
        ...
        scene: {
          emoji: "🏆⭐",
          description: "They won first prize in the competition!",
          character: "👦"
        },
        correctAnswer: "proud",
        question: "How does it feel?",
      ...
      },
      {
        ...
        scene: {
          emoji: "😴🛏️",
          description: "It's very late and they want to go to sleep.",
          character: "👧"
        },
        correctAnswer: "sleepy",
        question: "How does it feel?",
      ...
      },
      {
        ...
        scene: {
          emoji: "🎪🎉",
          description: "They saw something incredible that they didn't expect at all!",
          character: "👦"
        },
        correctAnswer: "surprised",
        question: "How does it feel?",
      ...
      },
      {
        ...
        scene: {
          emoji: "❤️🤗",
          description: "Their mom gave them a big hug!",
          character: "👧"
        },
        correctAnswer: "loved",
        question: "How does it feel?",
