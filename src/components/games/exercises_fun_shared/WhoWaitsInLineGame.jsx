// src/components/games/WhoWaitsInLineGame.jsx
    ...
    el: [
      {
        id: 1,
        scenario: {
          description: "Τέσσερα παιδιά περιμένουν στην ουρά για το νερόσουρτη.",
      ...
      },
      {
        id: 3,
        scenario: {
          description: "Παιδιά περιμένουν για να πάρουν το μεσημεριανό τους.",
          context: "Στο σχολείο - Κυλικείο"
        },
        ...
        children: [
          ...
          { id: "child3", emoji: "😫", behavior: "Φωνάζει 'Πεινάω πολύ!'", isPatient: false },
      ...
      },
      {
        id: 4,
        scenario: {
          description: "Παιδιά περιμένουν να πλυθούν τα χέρια τους.",
          context: "Στην τάξη"
        },
      ...
      },
      {
        id: 5,
        scenario: {
          description: "Παιδιά περιμένουν να μπουν στο σινεμά.",
          context: "Στο σινεμά"
        },
        correctAnswer: "child2",
        question: "Ποιο παιδί περιμένει υπομονετικά;",
      ...
      },
      {
        id: 6,
        scenario: {
          description: "Παιδιά περιμένουν να πάρουν παγωτό.",
      ...
      },
      {
        id: 7,
        scenario: {
          description: "Παιδιά περιμένουν να ανέβουν στο λεωφορείο.",
          context: "Στη στάση"
        },
        correctAnswer: "child1",
        question: "Ποιο παιδί περιμένει υπομονετικά;",
      ...
      },
      {
        id: 9,
        scenario: {
          description: "Παιδιά περιμένουν να πιουν νερό από το ποτηστήρι.",
          context: "Στο σχολείο"
        },
        correctAnswer: "child2",
        question: "Ποιο παιδί περιμένει υπομονετικά;",
      ...
      },
      {
        id: 10,
        scenario: {
          description: "Παιδιά περιμένουν να τους δώσουν μια μπάλα.",
          context: "Στο γυμναστήριο"
        },
        correctAnswer: "child3",
        question: "Ποιο παιδί περιμένει υπομονετικά;",
        children: [
          { id: "child1", emoji: "😤", behavior: "Αρπάζει τη μπάλα από άλλο παιδί", isPatient: false },
    ...
    en: [
      {
        id: 1,
        scenario: {
          description: "Four children are waiting in line for the water slide.",
      ...
      },
      {
        id: 3,
        scenario: {
          description: "Children are waiting to get their lunch.",
          context: "At school - Cafeteria"
        },
        correctAnswer: "child1",
        question: "Which child is waiting patiently?",
        children: [
          ...
          { id: "child3", emoji: "😫", behavior: "Yelling 'I'm so hungry!'", isPatient: false },
      ...
      },
      {
        id: 4,
        scenario: {
          description: "Children are waiting to wash their hands.",
      ...
      },
      {
        id: 5,
        scenario: {
          description: "Children are waiting to enter the cinema.",
      ...
      },
      {
        id: 6,
        scenario: {
          description: "Children are waiting to get ice cream.",
      ...
      },
      {
        id: 7,
        scenario: {
          description: "Children are waiting to get on the bus.",
      ...
      },
      {
        id: 9,
        scenario: {
          description: "Children are waiting to drink water from the fountain.",
          context: "At school"
        },
        correctAnswer: "child2",
        question: "Which child is waiting patiently?",
      ...
      },
      {
        id: 10,
        scenario: {
          description: "Children are waiting to be given a ball.",
          context: "In the gym"
        },
        correctAnswer: "child3",
        question: "Which child is waiting patiently?",
