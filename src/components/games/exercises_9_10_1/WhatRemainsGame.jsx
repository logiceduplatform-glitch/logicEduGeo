// src/components/games/exercises_9_10_1/WhatRemainsGame.jsx
...
export default function WhatRemainsGame({ lang = "el", onComplete, difficulty = 3 }) {
  ...
  const subtractionsData = {
    el: [
      { id: 1, emoji: "🍎", name: "μήλα", initial: 25, remove: 12, remaining: 13, options: [11, 13, 15], color: "#EF4444" },
      { id: 2, emoji: "🍌", name: "μπανάνες", initial: 30, remove: 17, remaining: 13, options: [12, 13, 14], color: "#EAB308" },
      { id: 3, emoji: "⭐", name: "αστέρια", initial: 40, remove: 18, remaining: 22, options: [20, 22, 24], color: "#F59E0B" },
      { id: 4, emoji: "🎈", name: "μπαλόνια", initial: 35, remove: 16, remaining: 19, options: [17, 19, 21], color: "#10B981" },
      { id: 5, emoji: "🍪", name: "μπισκότα", initial: 28, remove: 15, remaining: 13, options: [12, 13, 14], color: "#EC4899" },
      { id: 6, emoji: "🐟", name: "ψάρια", initial: 45, remove: 23, remaining: 22, options: [20, 22, 24], color: "#A855F7" },
      { id: 7, emoji: "🍓", name: "φράουλες", initial: 32, remove: 19, remaining: 13, options: [11, 13, 15], color: "#3B82F6" },
      { id: 8, emoji: "🌸", name: "λουλούδια", initial: 50, remove: 27, remaining: 23, options: [21, 23, 25], color: "#F97316" },
      { id: 9, emoji: "🦋", name: "πεταλούδες", initial: 38, remove: 24, remaining: 14, options: [12, 14, 16], color: "#14B8A6" },
      { id: 10, emoji: "🍬", name: "καραμέλες", initial: 42, remove: 28, remaining: 14, options: [12, 14, 16], color: "#8B5CF6" },
      { id: 11, emoji: "🐣", name: "κοτοπουλάκια", initial: 36, remove: 18, remaining: 18, options: [16, 18, 20], color: "#22C55E" },
      { id: 12, emoji: "🎵", name: "νότες", initial: 48, remove: 33, remaining: 15, options: [13, 15, 17], color: "#06B6D4" },
      { id: 13, emoji: "🌈", name: "κηρομπογιές", initial: 29, remove: 14, remaining: 15, options: [13, 15, 17], color: "#EC4899" },
      { id: 14, emoji: "🧸", name: "αρκουδάκια", initial: 44, remove: 29, remaining: 15, options: [13, 15, 17], color: "#F59E0B" },
      { id: 15, emoji: "🎀", name: "κορδέλες", initial: 50, remove: 35, remaining: 15, options: [13, 15, 17], color: "#EF4444" }
    ],
    en: [
      { id: 1, emoji: "🍎", name: "apples", initial: 25, remove: 12, remaining: 13, options: [11, 13, 15], color: "#EF4444" },
      { id: 2, emoji: "🍌", name: "bananas", initial: 30, remove: 17, remaining: 13, options: [12, 13, 14], color: "#EAB308" },
      { id: 3, emoji: "⭐", name: "stars", initial: 40, remove: 18, remaining: 22, options: [20, 22, 24], color: "#F59E0B" },
      { id: 4, emoji: "🎈", name: "balloons", initial: 35, remove: 16, remaining: 19, options: [17, 19, 21], color: "#10B981" },
      { id: 5, emoji: "🍪", name: "cookies", initial: 28, remove: 15, remaining: 13, options: [12, 13, 14], color: "#EC4899" },
      { id: 6, emoji: "🐟", name: "fish", initial: 45, remove: 23, remaining: 22, options: [20, 22, 24], color: "#A855F7" },
      { id: 7, emoji: "🍓", name: "strawberries", initial: 32, remove: 19, remaining: 13, options: [11, 13, 15], color: "#3B82F6" },
      { id: 8, emoji: "🌸", name: "flowers", initial: 50, remove: 27, remaining: 23, options: [21, 23, 25], color: "#F97316" },
      { id: 9, emoji: "🦋", name: "butterflies", initial: 38, remove: 24, remaining: 14, options: [12, 14, 16], color: "#14B8A6" },
      { id: 10, emoji: "🍬", name: "candies", initial: 42, remove: 28, remaining: 14, options: [12, 14, 16], color: "#8B5CF6" },
      { id: 11, emoji: "🐣", name: "chicks", initial: 36, remove: 18, remaining: 18, options: [16, 18, 20], color: "#22C55E" },
      { id: 12, emoji: "🎵", name: "notes", initial: 48, remove: 33, remaining: 15, options: [13, 15, 17], color: "#06B6D4" },
      { id: 13, emoji: "🌈", name: "crayons", initial: 29, remove: 14, remaining: 15, options: [13, 15, 17], color: "#EC4899" },
      { id: 14, emoji: "🧸", name: "bears", initial: 44, remove: 29, remaining: 15, options: [13, 15, 17], color: "#F59E0B" },
      { id: 15, emoji: "🎀", name: "ribbons", initial: 50, remove: 35, remaining: 15, options: [13, 15, 17], color: "#EF4444" }
    ]
  };
