...
export default function SpellingGame({ lang = "el", onComplete }) {
  ...
  const wordsData = {
    el: [
      { word: "ΒΙΒΛΙΟΘΗΚΗ", image: "📚", sound: "βιβλιοθήκη" },
      { word: "ΕΠΙΣΤΗΜΗ", image: "🔬", sound: "επιστήμη" },
      { word: "ΙΣΤΟΡΙΑ", image: "📜", sound: "ιστορία" },
      { word: "ΜΑΘΗΜΑΤΙΚΑ", image: "➗", sound: "μαθηματικά" },
      { word: "ΦΥΣΙΚΗ", image: "⚛️", sound: "φυσική" },
      { word: "ΔΙΑΒΑΣΗ", image: "📖", sound: "διάβαση" },
      { word: "ΠΛΑΝΗΤΗΣ", image: "🪐", sound: "πλανήτης" },
      { word: "ΥΠΟΛΟΓΙΣΤΗΣ", image: "💻", sound: "υπολογιστής" },
      { word: "ΓΛΩΣΣΑ", image: "🗣️", sound: "γλώσσα" },
      { word: "ΠΕΡΙΒΑΛΛΟΝ", image: "🌿", sound: "περιβάλλον" },
    ],
    en: [
      { word: "LIBRARY", image: "📚", sound: "library" },
      { word: "SCIENCE", image: "🔬", sound: "science" },
      { word: "HISTORY", image: "📜", sound: "history" },
      { word: "DISCOVERY", image: "🔭", sound: "discovery" },
      { word: "LANGUAGE", image: "🗣️", sound: "language" },
      { word: "COMPUTER", image: "💻", sound: "computer" },
      { word: "PLANET", image: "🪐", sound: "planet" },
      { word: "KNOWLEDGE", image: "🎓", sound: "knowledge" },
      { word: "ECOSYSTEM", image: "🌿", sound: "ecosystem" },
      { word: "ADVENTURE", image: "🗺️", sound: "adventure" },
    ],
  };
    ...
    <div className="relative w-full min-h-screen bg-gradient-to-br from-yellow-100 via-orange-100 to-pink-100 p-4 sm:p-8 rounded-xl overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white/90 backdrop-blur rounded-3xl p-8 shadow-xl border-4 border-orange-400">
          ...
          <div className="mb-6">
            <div className="flex justify-center gap-2 min-h-20 p-4 bg-gradient-to-r from-yellow-50 to-orange-50 rounded-2xl border-4 border-orange-300 flex-wrap">
              {Array.from({ length: currentWord.word.length }).map((_, idx) => (
                <button
                  key={idx}
                  onClick={() => handleRemoveLetter(idx)}
                  className={`w-14 h-14 sm:w-16 sm:h-16 rounded-xl text-2xl sm:text-3xl font-bold flex items-center justify-center transition-all ${
                    selectedLetters[idx]
              ...
              {letterOptions.map((letter, idx) => {
                ...
                return (
                  <button
                    ...
                    disabled={isUsed}
                    className={`p-4 rounded-xl text-xl sm:text-2xl font-bold transition-all ${
                      isUsed
