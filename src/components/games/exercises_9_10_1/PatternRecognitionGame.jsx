// src/components/games/exercises_9_10_1/PatternRecognitionGame.jsx
...
export default function PatternRecognitionGame({ lang = "el", onComplete }) {
  ...
  const roundsData = {
    el: [
      ...
      { id: 3, question: "Ποιο έρχεται μετά;", pattern: ["🐶", "🐱", "🐦", "🐠", "🐶", "🐱", "🐦"], correctAnswer: "🐠", options: ["🐶", "🐠", "🐱"], color: "#10B981" },
      { id: 4, question: "Ποιο έρχεται μετά;", pattern: ["❤️", "💙", "💚", "💛", "💜", "❤️", "💙", "💚", "💛"], correctAnswer: "💜", options: ["❤️", "💜", "💚"], color: "#EC4899" },
      { id: 5, question: "Ποιο έρχεται μετά;", pattern: ["🍎", "🍌", "🍊", "🍇", "🍓", "🍎", "🍌", "🍊", "🍇"], correctAnswer: "🍓", options: ["🍎", "🍓", "🍊"], color: "#EF4444" },
      { id: 6, question: "Ποιο έρχεται μετά;", pattern: ["🔵", "🔵", "🟢", "🟢", "🟢", "🔵", "🔵", "🟢", "🟢", "🟢", "🔵", "🔵"], correctAnswer: "🟢", options: ["🔵", "🟢", "🔴"], color: "#3B82F6" },
      { id: 7, question: "Ποιο έρχεται μετά;", pattern: ["🌸", "🌸", "🌻", "🌸", "🌸", "🌻", "🌸", "🌸"], correctAnswer: "🌻", options: ["🌸", "🌻", "🌹"], color: "#A855F7" },
      { id: 8, question: "Ποιο έρχεται μετά;", pattern: ["🎈", "🎀", "🎈", "🎀", "🎈", "🎈", "🎀", "🎈", "🎀", "🎈"], correctAnswer: "🎈", options: ["🎈", "🎀", "🎁"], color: "#06B6D4" },
      ...
      { id: 12, question: "Ποιο έρχεται μετά;", pattern: ["🐣", "🐥", "🐔", "🦆", "🐦", "🐣", "🐥", "🐔", "🦆"], correctAnswer: "🐦", options: ["🐣", "🐦", "🐔"], color: "#22C55E" },
      { id: 13, question: "Ποιο έρχεται μετά;", pattern: ["🎵", "🎶", "🔔", "🥁", "🎺", "🎵", "🎶", "🔔", "🥁"], correctAnswer: "🎺", options: ["🎵", "🎺", "🔔"], color: "#8B5CF6" },
      { id: 14, question: "Ποιο έρχεται μετά;", pattern: ["🌺", "🍀", "🌻", "🌼", "🌸", "🌺", "🍀", "🌻", "🌼"], correctAnswer: "🌸", options: ["🌺", "🌸", "🌻"], color: "#EC4899" },
    ...
    en: [
      ...
      { id: 3, question: "What comes next?", pattern: ["🐶", "🐱", "🐦", "🐠", "🐶", "🐱", "🐦"], correctAnswer: "🐠", options: ["🐶", "🐠", "🐱"], color: "#10B981" },
      { id: 4, question: "What comes next?", pattern: ["❤️", "💙", "💚", "💛", "💜", "❤️", "💙", "💚", "💛"], correctAnswer: "💜", options: ["❤️", "💜", "💚"], color: "#EC4899" },
      { id: 5, question: "What comes next?", pattern: ["🍎", "🍌", "🍊", "🍇", "🍓", "🍎", "🍌", "🍊", "🍇"], correctAnswer: "🍓", options: ["🍎", "🍓", "🍊"], color: "#EF4444" },
      { id: 6, question: "What comes next?", pattern: ["🔵", "🔵", "🟢", "🟢", "🟢", "🔵", "🔵", "🟢", "🟢", "🟢", "🔵", "🔵"], correctAnswer: "🟢", options: ["🔵", "🟢", "🔴"], color: "#3B82F6" },
      { id: 7, question: "What comes next?", pattern: ["🌸", "🌸", "🌻", "🌸", "🌸", "🌻", "🌸", "🌸"], correctAnswer: "🌻", options: ["🌸", "🌻", "🌹"], color: "#A855F7" },
      { id: 8, question: "What comes next?", pattern: ["🎈", "🎀", "🎈", "🎀", "🎈", "🎈", "🎀", "🎈", "🎀", "🎈"], correctAnswer: "🎈", options: ["🎈", "🎀", "🎁"], color: "#06B6D4" },
      ...
      { id: 12, question: "What comes next?", pattern: ["🐣", "🐥", "🐔", "🦆", "🐦", "🐣", "🐥", "🐔", "🦆"], correctAnswer: "🐦", options: ["🐣", "🐦", "🐔"], color: "#22C55E" },
      { id: 13, question: "What comes next?", pattern: ["🎵", "🎶", "🔔", "🥁", "🎺", "🎵", "🎶", "🔔", "🥁"], correctAnswer: "🎺", options: ["🎵", "🎺", "🔔"], color: "#8B5CF6" },
      { id: 14, question: "What comes next?", pattern: ["🌺", "🍀", "🌻", "🌼", "🌸", "🌺", "🍀", "🌻", "🌼"], correctAnswer: "🌸", options: ["🌺", "🌸", "🌻"], color: "#EC4899" },
